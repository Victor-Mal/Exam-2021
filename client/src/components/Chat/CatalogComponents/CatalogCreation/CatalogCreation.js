                    ...
                    <div className={styles.catalogCreationContainer}>
                      ...
                      <div className={styles.buttonsContainer}>
                        <span
                          ...
                          className={classNames(styles.new, { [styles.active]: catalogCreationMode === ADD_CHAT_TO_OLD_CATALOG })}
                        >
                          Old
                        </span>
                        <span
                          onClick={() => changeTypeOfChatAdding(CREATE_NEW_CATALOG_AND_ADD_CHAT)}
                          className={classNames(styles.old, { [styles.active]: catalogCreationMode === CREATE_NEW_CATALOG_AND_ADD_CHAT })}
                        >
                          New
                        </span>
                      </div>
